...
public class AuthController {
    ...
    /**
     * User login with credentials and CAPTCHA verification
     */
    @Operation(summary = "User Login", description = "Authenticate user with username/email, password and CAPTCHA token. Returns JWT token with expiration time. Remember me option extends token validity to 30 days.")
    @PostMapping("/login")
